        ...
        <div class="flex items-center mb-3">
            <nav aria-label="breadcrumb">
                <ol class="flex space-x-2 mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active text-gray-800" aria-current="page">All Post</li>
                </ol>
            </nav>
            <div class="ml-auto">
                <div class="flex space-x-2">
                    <a href="{{ route('add.post') }}" class="bg-blue-500 text-white px-3 py-2 rounded hover:bg-blue-600">
                        Add Post
                    </a>
                </div>
            </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($posts as $key => $item)
                                <tr>
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap">{{ $item->category->name ?? 'No Category' }}
                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap">{{ $item->authors->name ?? 'No Author' }}</td>
