        ...
        <div class="flex items-center mb-3">
            <nav aria-label="breadcrumb">
                <ol class="flex space-x-2 mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active text-gray-800" aria-current="page">Add Post</li>
                </ol>
            </nav>
        </div>
        <div class="shadow-lg rounded-lg bg-white p-6">
            <form action="{{ route('store.post') }}" method="POST" enctype="multipart/form-data" id="postForm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-6">
                    ...
                    <div>
                        <label for="is_featured" class="block text-sm font-medium leading-6 text-gray-900">Is
                            Featured</label>
                    ...
                    <div>
                        ...
                        <div id="imagePreviewContainer" class="flex mt-2 space-x-4 overflow-x-auto"></div>
                    </div>
                </div>
