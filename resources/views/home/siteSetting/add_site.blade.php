...
@section('content')
    <div class="page-content mx-4">
        <div class="shadow-lg rounded-lg bg-white p-6">
            <h4 class="block text-base font-bold leading-6 py-6 active text-gray-800">Add Site Details</h4>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-6 ">
                    <div class="shadow p-6  border  rounded">
                        ...
                        <div class="mt-4">
                            ...
                            <div id="logoImagePreviewContainer" class="relative mt-2" style="display:none;">
                                <div class="relative inline-block">
                                    ...
                                    <button class="absolute top-1 right-1 bg-red-500 text-white rounded-full p-1"
                                        onclick="removeLogoImage()" type="button">&#10006;</button>
                                </div>
                            </div>
                            @error('logo')
                                <span class="text-red-600 text-sm">{{ $message }}</span>
                    ...
                    <div class="shadow  p-6  border  rounded">
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <input type="text" name="port" id="port" autocomplete="port"
                                    class="block w-full rounded-md border py-2 text-gray-900 shadow-sm ring-1 ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                            @error('port')
                                <span class="text-red-600 text-sm">{{ $message }}</span>
