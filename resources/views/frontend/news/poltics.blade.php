...
<body>
    ...
    <div class="flex flex-col mx-5">
        ...
        <p class="flex text-4xl font-bold py-5 mx-5 sm:mx-10 md:mx-20 lg:mx-24">Politics</p>
        ...
        <div class="flex flex-col md:flex-row py-6 md:py-8 lg:py-10 space-y-5 md:space-y-0 md:space-x-5 gap-5 mx-5 sm:mx-10 md:mx-20 lg:mx-24">
            ...
            <div class="flex-shrink-0">
                <img class="cursor-pointer w-[80px] sm:w-[120px] md:w-[200px] lg:w-[400px] " onclick="window.location.href='/detail';" src="{{ asset('assets/images/dipak.png') }}" alt="About Us Image">
            </div>
        ...
        <div class="flex flex-col lg:flex-row xl:gap-3 p-2 my-2 py-20 mx-5 sm:mx-10 md:mx-20 lg:mx-20">
            ...
            <div class="flex flex-col gap-10">
                <div class="w-full flex flex-col md:flex-row gap-5">
                    <img class="cursor-pointer w-[80px] sm:w-[120px] md:w-[200px] lg:w-[250px] rounded" onclick="window.location.href='/detail';" src="{{ asset('assets/images/dipak.png') }}" alt="About Us Image">
            ...
            <div class="w-[80%]  flex flex-col gap-5 ">
                <div class="flex flex-col md:flex-row gap-2 p-2">
                    ...
                    <img class="cursor-pointer w-[40px] sm:w-[80px] md:w-[100px] lg:w-[170px] h-auto" onclick="window.location.href='/detail';" src="{{ asset('assets/images/dipak.png') }}" alt="About Us Image">
                </div>
                <div class="border-[1px]"></div>
                <div class="flex flex-col md:flex-row gap-2 p-2">
                    <h2 class="text-sm leading-[1.4] font-inter font-bold tracking-inherit cursor-pointer hover:text-texthead" onclick="window.location.href='/detail';">
